	...
	var nodeListForEach = function(list, callback) {
 	...
 	return {
 		...
 		displayBudget: function(obj) {
			...
			//create and set bar to current obje.percentage
			var bar1 = new ldBar("#semi-bar");
			bar1.set(obj.percentage);				
 		},
 		...
 		changedType: function() {
			...
			//create a black border on the barLabels ('income or expenses') when selected in the type button ( + or -)
			var isExp = document.querySelector(DOMstrings.inputType).value;
			if (isExp === 'exp') {
				document.getElementById('incomeBar').classList.remove('blackBorder');
				document.getElementById('expensesBar').classList.add('blackBorder');
			} else {
				document.getElementById('expensesBar').classList.remove('blackBorder');
				document.getElementById('incomeBar').classList.add('blackBorder');
